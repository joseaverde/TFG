...
#let reqs = srs.create(
  ...
  */
  ...
  (
    Descripción: [
      ...
      que se integre con la base de código antigua y permita entrenar el modelo],
    Necesidad: "m",
    Prioridad: "l",
    Estabilidad: "c",
    Verificabilidad: "h",
  ...
  */
  ...
  make-item("rnf-ritmo-de-muestreo", srs.make-tag("R", "N"),
    origins: (srs.make-tag("CU", "uc-sample"),),
  (
    Descripción: [
  ...
  make-item("rnf-energy-error", srs.make-tag("R", "N"),
    origins: (srs.make-tag("CU", "uc-train"),),
  (
    Descripción: [
      Debe haber un error medio absoluto de máximo $10^(-6)$ en la función
  ...
  make-item("rnf-dtw-error", srs.make-tag("R", "N"),
    origins: (srs.make-tag("CU", "uc-train"),),
  (
    Descripción: [
  ...
  make-item("rnf-psd-1-error", srs.make-tag("R", "N"),
    origins: (srs.make-tag("CU", "uc-train"),),
  (
    Descripción: [
      Debe haber un error medio absoluto de máximo $0.5$ en la función
      `PSD 1` con respecto a la implementación original en Python 3.
    ],
    Necesidad: "m",
    Prioridad: "l",
    Estabilidad: "c",
  ...
  make-item("rnf-psd-2-error", srs.make-tag("R", "N"),
    origins: (srs.make-tag("CU", "uc-train"),),
  (
    Descripción: [
      Debe haber un error medio absoluto de máximo $0.5$ en la función
      `PSD 2` con respecto a la implementación original en Python 3.
    ],
    Necesidad: "m",
    Prioridad: "l",
    Estabilidad: "c",
  ...
  make-item("rnf-psd-3-error", srs.make-tag("R", "N"),
    origins: (srs.make-tag("CU", "uc-train"),),
  (
    Descripción: [
      Debe haber un error medio absoluto de máximo $0.5$ en la función
      `PSD 3` con respecto a la implementación original en Python 3.
    ],
    Necesidad: "m",
    Prioridad: "l",
    Estabilidad: "c",
  ...
  make-item("c-validador", srs.make-tag("C"), (
    ...
    Entrada: [
      - Detección: Utiliza las detecciones generadas por el
        #reference("c-detector", [detector]) computar la puntuación $F_1$.
    ],
    Salida: [
  ...
  make-item("c-entrenador", srs.make-tag("C"), (
    ...
    Descripción: [
      El componente genera múltiples modelos (_batches_) y los valida contra
      el #reference("c-validador", [validador]), el cual utiliza para optimizar
      la puntuación $F_1$ del modelo resultante.
    ],
  ...
  make-item("c-detector", srs.make-tag("C"), (
    ...
    Descripción: [
      A partir de un modelo generado (_batch_), clasifica épocas de señal
      en dos categorías: «zona libre de ataque epiléptico» y en «zona con
      ataque epiléptico».
    ],
  ...
  */
  ...
  make-item("t-python3-module", srs.make-tag("T"),
  ...
  make-item("t-classify-true", srs.make-tag("T"),
  ...
  make-item("t-classify-false-feature", srs.make-tag("T"),
    origins: (srs.make-tag("R", "F", "rf-classify"),
              srs.make-tag("R", "F", "rf-notify")),
  (
    ...
    Precondiciones: [
      1. Se utiliza una señal sintética de 1280.
      2. Se genera un _batch_ con patrón idéntico a la señal sintética.
         Los rangos de las características serán $[0, infinity)$.
  ...
  make-item("t-classify-false-dtw", srs.make-tag("T"),
    origins: (srs.make-tag("R", "F", "rf-classify"),
              srs.make-tag("R", "F", "rf-notify")),
  (
    ...
    Postcondiciones: [
      ...
      $[0, 0)$ siempre debe dar falso, y como el intervalo $[0, x)$ es abierto,
      nunca lo detecta como ataque.
    ],
    Evaluación: "ok",
  )),

  make-item("t-classify-true-many-patterns", srs.make-tag("T"),
    origins: (srs.make-tag("R", "F", "rf-classify"),
              srs.make-tag("R", "F", "rf-notify")),
  (
    Descripción: [El detector identifica ataques.],
  ...
  make-item("t-read", srs.make-tag("T"),
  ...
  make-item("t-muestras-por-segundo", srs.make-tag("T"),
    origins: (
  ...
  (
    ...
    Postcondiciones: [
      ...
      a una muestra por cada una ducentésima quincuagésima sexta parte de un
      segundo.
    ],
    Evaluación: "ok",
  )),

  make-item("t-épocas-por-segundo", srs.make-tag("T"),
    origins: (srs.make-tag("R", "N", "rnf-épocas-por-segundo"),
  ...
  make-item("t-no-fallo", srs.make-tag("T"),
  ...
  (
    ...
    Postcondiciones: [
      Si compila tenemos la certeza de que no puede saltar ninguna excepción en
      tiempo de ejecución, porque el probador de teoremas nos garantiza
